...
Calculation and drawing documents provide detailed road maps for engineering
projects. Their clarity and completeness affect cost, quality and timeliness.
**rivt** is a tool for improving clarity and completeness by applying open
source software principles to engineering design documents. Engineering
professions have an opportunity to produce reusable calculation libraries that
can evolve and improve with open-source contributions over time.

Because many engineering technologies in the 21st century are evolving slowly,
standards may see little or no change for decades. Productive engineering work
now lies, not so much in technological innovation, but in understanding and
combining various established technologies.

Engineering documents are the mechanism for working out how to make these
combinations successful. Enabling cut and paste editing of text, figures,
formulas, calculation, graphs and tabulated data from existing documents
enables several improvements. Engineers can explore more options. They can
converge on effective design solutions faster. And they can explore unfamiliar
technologies more efficiently. When large numbers of the profession participate
the document quality evolves rapidly.

Many engineering caclulation programs are available, but they include barriers
to sharing and reuse (see table). In general they include incompatibility
between programs, high initial and continuing software upgrade costs, and
limited formatting and version control features.

Nearly identical engineering documents are now being repeatedly written simply
because a general, generic format was unavailable. **rivt** was developed to
promote professio-wide document evolution and reuse.
