...
The minimum Python version requirement is *3.13.0*. The recommended method for
installing *rivt* is :doc:`rivt-uv </dv-B-install/rv-B01-install>`.


=============================================== ================================
      Dependency                                      description
=============================================== ================================
  "tabulate>=0.9.0"                                format tabular data                  
  "pillow>=11.2.1"                                 imaging processing
