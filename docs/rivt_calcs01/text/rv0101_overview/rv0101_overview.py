#! python
# %%
import rivtlib.rivt as rv

rv.R(
    """Summary [n]_

    [readme]__ The project includes renovations, repairs and alterations to
    improve the function and seismic resistance of a single story, wood
    framed residence with an attached car port and under-house storage space.
    
    Alterations include remodeling the kitchen, bathroom and living room; adding
    a new bathroom and exterior laundry enclosure. Renovations include
    installing a retaining wall, sidewalk and exterior hand-rail; replacing
    the carport foundations and driveway; and seismically strengthening the
    carport framing and residence foundation walls. The work did not change
    the building foot print.
    
    || output | term | rivt | Overview - Residence Renovations | 1 
...
rv.V(
    ...
    || insert | image1 | house01.jpg | 60 
    Residence viewed from Loring Drive [f]_"""
)
# %%
rv.V(
    """Building Codes and Site [n]_
    ...
    || eval | table | cbc2019_stds.xlsx | 53,L | [:]
    
    || insert | image | site01.jpg, site02.jpg | 35,35
...
rv.T(
    """Math and Text Abbreviations [n]_
