...
rv.R(
    """
    || output | "pdf", "default", "Carport Seismic Model", "37"
    """
)

rv.I(
    """[01]  Carport Seismic Demands 
...
rv.I(
    """[02]  Seismic D-C Ratios for Braces
...
rv.I(
    """[03]  Seismic D-C Ratios for Beam Connections 
...
rv.V(
    """[04] Seismic D-C Ratios for Column Base
