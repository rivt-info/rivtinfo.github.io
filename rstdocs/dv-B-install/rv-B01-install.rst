...
*rivt* is a Python project. It includes :doc:`rivtlib </dv-A-intro/rv-A01-intro>`
and two dozen  :doc:`Python packages </dv-B-install/rv-B02-python>`. When
...
:doc:`here </dv-B-install/rv-B01-install>`.
...
#. `VSCode <https://code.visualstudio.com/>`_ and 
   ...
   *rivt* extensions and snippets are :doc:`here </dv-B-install/rv-B03-vscode>`.
