...
Global settings can be exported and imported using VSCode Profiles.
...
VSCode *rivt* extensions may be installed by downloading and running the shell
or batch command here.
