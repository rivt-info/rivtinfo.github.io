...
.. topic::  _[[VALUES]] topic title

    ::
        
        _[[VALUES]] topic title
        c_1 := 5*unit | unit1, unit2, decimal | label
        c_2 := 2.2*unit | unit1, unit2, decimal | label
        ...
        _[[QUIT]]
...
.. topic:: | TEXT | relative path | *literal*; code type
