...
Commands read and write external. They are start with double vertical bars (||) at
...
and optional list elements are separated with commas.
...
Functions          Command
---------------- ---------------------------------------------------------------
rv.I               || **append** | relative path | file.pdf
---                attaches PDF files to end of the doc
rv.I, rv.V         || **text** | relative path | rivt; plain
---                 inserts and formats plain or rivt tagged files
rv.I, rv.V         || **image**  | relative path1 (,path2) | width1 (,width2)
---                 inserts and formats png or jpg files    
rv.I, rv.V         || **table** | relative path | max col width, align    
---                 inserts and formats tabular data from csv or xls files
rv.V               || **declare** | relative path |  print; noprint
---                 imports values from a rivt csv file
================ ===============================================================
...
rv.I, rv.V       _[address, label] url or internal reference
rv.I, rv.V         _[page]         footnote description
================ ================= ================================================  
...
Functions          Tag                   Description
---------------- -------------- ------------------------------------------------
rv.V               = (declare)     a = (2*IN + 3*IN)*1.2*FT | descrip
rv.V               := (assign)     b: = 112.5*LBF | descrip
================ ============== ================================================  
...
Functions          Tag                   Description
---------------- ----------------- ------------------------------------------------
rv.I, rv.V         _[[b]]           start bold text block
rv.I, rv.V         _[[c]]           start center text block
rv.I, rv.V         _[[i]]           start italic text block
rv.I, rv.V         _[[l]]           start latex block
rv.I, rv.V         _[[p]]           start plain text block
